        ...
        if (command.getName().equalsIgnoreCase("phantomisolation")) {
            ...
            if (args[0].equalsIgnoreCase("check")) {
                if (sender instanceof Player) {
                    ...
                    sender.sendMessage("Phantom isolation status: " + databaseManager.getPlayerIsolationStatus(player));
                } else {
                ...
                if (sender instanceof Player) {
                    Player player = (Player) sender;
                    databaseManager.setPlayerIsolationStatus(player, false);
                ...
                if (sender instanceof Player) {
                    Player player = (Player) sender;
                    databaseManager.setPlayerIsolationStatus(player, true);
